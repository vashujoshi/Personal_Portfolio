export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 4,
      title: "Problem solver with a passion for development.",
      description: "",
    ...
    {
      id: 5,
      title: "Currently building a Job portal using NEXTJS",
  ...
  export const projects = [
      ...
      {
      id: 2,
      title: "Interactive game with infinite possibilities",
    ...
    {
      id: 3,
      title: "Chatroom based application",
